 ...
 */
extern float fresnelDiel(float cosThetaI, float extIOR, float intIOR);
 ...
 *      Refractive index of the interior
 */
extern float fresnelDielCos(float cosThetaI, float &cosThetaT, float extIOR, float intIOR);

/**
 * \brief Calculates the unpolarized fresnel reflection coefficient for a
 * conductor material. Handles incidence from either side (i.e.
 * \code cosThetaI<0 is allowed).
 *
 * \param cosThetaI
 *      Cosine of the angle between the normal and the incident ray
 * \param eta
 *      Refractive index of the conductor
 * \param k
 *      Absorption coefficient of the conductor
 */
extern Color3f fresnelCond(float cosThetaI, Color3f eta, Color3f k);
