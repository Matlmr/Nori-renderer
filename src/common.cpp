...
float fresnelDiel(float cosThetaI, float extIOR, float intIOR) {
    float cosThetaT;
    return fresnelDielCos(cosThetaI, cosThetaT, extIOR, intIOR);
}

float fresnelDielCos(float cosThetaI, float& cosThetaT, float extIOR, float intIOR) {
...
Color3f fresnelCond(float cosThetaI, Color3f eta, Color3f k) {
